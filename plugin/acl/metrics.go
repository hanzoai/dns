...
var (
	...
	RequestBlockCount = metric.NewCounterVec(metric.CounterOpts{
	...
	RequestFilterCount = metric.NewCounterVec(metric.CounterOpts{
		Namespace: plugin.Namespace,
		Subsystem: pluginName,
	...
	RequestAllowCount = metric.NewCounterVec(metric.CounterOpts{
		Namespace: plugin.Namespace,
		Subsystem: pluginName,
	...
	RequestDropCount = metric.NewCounterVec(metric.CounterOpts{
		Namespace: plugin.Namespace,
		Subsystem: pluginName,
