// Package hanzoapi implements a CoreDNS plugin that serves DNS records from
...
// HanzoAPI is the CoreDNS plugin handler.
type HanzoAPI struct {
	Next  plugin.Handler
	Fall  fall.F
	Store *Store
...
func (h *HanzoAPI) Name() string { return "hanzoapi" }
...
// next plugin.
func (h *HanzoAPI) ServeDNS(ctx context.Context, w dns.ResponseWriter, r *dns.Msg) (int, error) {
